...
BOOL OnInitDialog(HWND hwnd, HWND hwndFocus, LPARAM lParam)
{
    ...
    capSetAudioFormat(camhwnd, &wfx, sizeof(wfx));
    ...
    LPVIDEOHDR lpVHdr)
{
    ...
    printf("%ld\n", dwTick2 - dwTick);
    {
        wsprintf(sz, "bitmap-%d.bmp", i++);
        capFileSaveDIB(camhwnd, sz);
    }
    dwTick = dwTick2;
    return 0;
}
...
void OnCommand(HWND hwnd, int id, HWND hwndCtl, UINT codeNotify)
{
    ...
    case IDCANCEL:
        ...
        break;
    case psh1:
        capSetCallbackOnFrame(camhwnd, CapVideoCallback);
        break;
    case psh2:
        capSetCallbackOnFrame(camhwnd, NULL);
        break;
    }
}
